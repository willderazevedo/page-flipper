    ...
    ?>
        <div x-data="flipperBuilder" class="flipper-builder-wrapper">
            ...
            <div class="flipper-page">
                <img src="https://mis-ce.org.br/storage/publications/February2025/7QwDXFWkItK0FPG8zx7o.jpg">
                ...
                <div class="page-actions">
                    ...
                    <button type="button" description="<?php _e('Audio', 'page-flipper'); ?>" class="add-audio-hotspot">
                    ...
                    <button type="button" description="<?php _e('Video', 'page-flipper'); ?>" class="add-video-hotspot">
                    ...
                    <button type="button" description="<?php _e('Image', 'page-flipper'); ?>" class="add-picture-hotspot">
                    ...
                    <button type="button" description="<?php _e('Text', 'page-flipper'); ?>" class="add-text-hotspot">
                    ...
                    <button type="button" description="<?php _e('Hyperlink', 'page-flipper'); ?>" class="add-link-hotspot">
