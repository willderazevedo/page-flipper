...
require_once plugin_dir_path( __FILE__ ) . 'fields/flipper-background.php';
...
function wa_page_flipper_post_type_register() {
    ...
    $labels = [
        ...
        'featured_image'        => __( 'Digital Book Cover', 'page-flipper' ),
        'set_featured_image'    => __( 'Set Digital Book Cover', 'page-flipper' ),
        'remove_featured_image' => __( 'Remove Digital Book Cover', 'page-flipper' ),
    ];
...
function wa_page_flipper_admin_assets() {
    ...
    wp_enqueue_style('flipper-style', plugin_dir_url(__FILE__) . 'assets/admin/style.css', [], '1.0.13');
    wp_enqueue_style('flipper-icons-lib', plugin_dir_url(__FILE__) . 'assets/libs/fontawesome.css', [], '6.5.1');
    wp_enqueue_script('flipper-script', plugin_dir_url(__FILE__) . 'assets/admin/main.js', ['flipper-sortable-lib', 'flipper-interact-lib'], '1.0.13', true);
}
...
function wa_page_flipper_frontend_assets() {
    ...
    wp_enqueue_style('flipper-style', plugin_dir_url(__FILE__) . 'assets/frontend/style.css', [], '1.0.13');
    wp_enqueue_style('flipper-icons-lib', plugin_dir_url(__FILE__) . 'assets/libs/fontawesome.css', [], '6.5.1');
    wp_enqueue_script('flipper-script', plugin_dir_url(__FILE__) . 'assets/frontend/main.js', ['flipper-turnjs-lib', 'flipper-zoom-lib', 'flipper-bootstrap-lib', 'flipper-sharer-lib'], '1.0.13', true);
}
